...
public:
    ...
    static Eigen::Vector4d toHomoPos(const Eigen::Vector3d &v);
    static Eigen::Vector4f toHomoPos(const Eigen::Vector3f &v);
    static Eigen::Vector3d toPos(const Eigen::Vector4d &v);
    static Eigen::Vector3f toPos(const Eigen::Vector4f &v);
