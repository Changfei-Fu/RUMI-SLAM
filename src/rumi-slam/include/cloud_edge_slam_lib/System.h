...
public:
    ...
    // For Cloud
    void GetCloudProcessImages(std::vector<CloudImage> &vCloudProcessImages, std::vector<CloudImage> &vCloudProcessNoSamplingImages, int &edgeFrontMapId, int &edgeBackMapId);
    void ResetCloudProcessImages();
    void SetTrackLostTimestamp(double t);
    ...
    void SaveAtlasCustom(Atlas *atlas, const string &savePath, int type);
    bool LoadAtlasCustom(Atlas *atlas, const string &loadPath, int type);
    Atlas *GetAtlas();
...
private:
    ...
    CloudImageSampler *mpCloudImageSampler;
