...
EdgeWorldSim3ProjectXYZ::EdgeWorldSim3ProjectXYZ(g2o::Sim3 gSc1w, g2o::Sim3 gSc2w) :
    g2o::BaseBinaryEdge<2, Eigen::Vector2d, g2o::VertexSBAPointXYZ, VertexSim3Expmap>(),
    gSc1w(gSc1w), gSc2w(gSc2w) {
}

bool EdgeWorldSim3ProjectXYZ::read(std::istream &is) {
    for (int i = 0; i < 2; i++) {
        is >> _measurement[i];
    }
...
bool EdgeWorldSim3ProjectXYZ::write(std::ostream &os) const {
    for (int i = 0; i < 2; i++) {
        os << _measurement[i] << " ";
    }
...
EdgeSim3XYZ::EdgeSim3XYZ() :
    g2o::BaseBinaryEdge<3, Eigen::Vector3d, g2o::VertexSBAPointXYZ, VertexSim3Expmap>() {
}
...
EdgeInverseWorldSim3ProjectXYZ::EdgeInverseWorldSim3ProjectXYZ(g2o::Sim3 gSc1w, g2o::Sim3 gSc2w) :
    g2o::BaseBinaryEdge<2, Eigen::Vector2d, g2o::VertexSBAPointXYZ, VertexSim3Expmap>(),
    gSc1w(gSc1w), gSc2w(gSc2w) {
}

bool EdgeInverseWorldSim3ProjectXYZ::read(std::istream &is) {
    for (int i = 0; i < 2; i++) {
        is >> _measurement[i];
    }
...
bool EdgeInverseWorldSim3ProjectXYZ::write(std::ostream &os) const {
    for (int i = 0; i < 2; i++) {
        os << _measurement[i] << " ";
    }
...
EdgeInverseSim3XYZ::EdgeInverseSim3XYZ() :
    g2o::BaseBinaryEdge<3, Eigen::Vector3d, g2o::VertexSBAPointXYZ, VertexSim3Expmap>() {
}

bool EdgeInverseSim3XYZ::read(std::istream &is) {
    for (int i = 0; i < 2; i++) {
        is >> _measurement[i];
    }
...
bool EdgeInverseSim3XYZ::write(std::ostream &os) const {
    for (int i = 0; i < 2; i++) {
        os << _measurement[i] << " ";
    }
