...
class EdgeSim3XYZ : public g2o::BaseBinaryEdge<3, Eigen::Vector3d, g2o::VertexSBAPointXYZ, ORB_SLAM3::VertexSim3Expmap> {
public:
    EIGEN_MAKE_ALIGNED_OPERATOR_NEW
    EdgeSim3XYZ();
    virtual bool read(std::istream &is);
    ...
    void computeError() {
        ...
        // std::cout << "id2 -> obs1 error: " << _error(0) << " " << _error(1) << std::endl;
    }

    // virtual void linearizeOplus();
};

class EdgeInverseSim3XYZ : public g2o::BaseBinaryEdge<3, Eigen::Vector3d, g2o::VertexSBAPointXYZ, ORB_SLAM3::VertexSim3Expmap> {
public:
    EIGEN_MAKE_ALIGNED_OPERATOR_NEW
    EdgeInverseSim3XYZ();
    virtual bool read(std::istream &is);
...
class EdgeWorldSim3ProjectXYZ : public g2o::BaseBinaryEdge<2, Eigen::Vector2d, g2o::VertexSBAPointXYZ, ORB_SLAM3::VertexSim3Expmap> {
public:
    EIGEN_MAKE_ALIGNED_OPERATOR_NEW
    EdgeWorldSim3ProjectXYZ(g2o::Sim3 gSc1w, g2o::Sim3 gSc2w);
    virtual bool read(std::istream &is);
    virtual bool write(std::ostream &os) const;
    ...
    void computeError() {
        ...
        g2o::Sim3 gSc1c2 = gSc1w * v1->estimate() * gSc2w.inverse();

        Eigen::Vector2d obs(_measurement);
        _error = obs - v1->pCamera1->project(gSc1c2.map(v2->estimate()));
        // std::cout << "id2 -> obs1 error: " << _error(0) << " " << _error(1) << std::endl;
    }
...
public:
    ...
    void computeError() {
        ...
        // std::cout << "id1 -> obs2 error: " << _error(0) << " " << _error(1) << std::endl;
    }

    // virtual void linearizeOplus();
};

class EdgeInverseWorldSim3ProjectXYZ : public g2o::BaseBinaryEdge<2, Eigen::Vector2d, g2o::VertexSBAPointXYZ, VertexSim3Expmap> {
public:
    EIGEN_MAKE_ALIGNED_OPERATOR_NEW
    EdgeInverseWorldSim3ProjectXYZ(g2o::Sim3 gSc1w, g2o::Sim3 gSc2w);
    virtual bool read(std::istream &is);
    virtual bool write(std::ostream &os) const;
    ...
    void computeError() {
        ...
        g2o::Sim3 gSc2c1 = gSc2w * v1->estimate().inverse() * gSc1w.inverse();

        Eigen::Vector2d obs(_measurement);
        _error = obs - v1->pCamera2->project((gSc2c1.map(v2->estimate())));
        // std::cout << "id1 -> obs2 error: " << _error(0) << " " << _error(1) << std::endl;
    }
