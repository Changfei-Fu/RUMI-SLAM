...
public:
    ...
    void SetCloudImageSampler(CloudImageSampler *pCloudImageSampler);
    ...
    void InformSetImgGray(const bool &flag);
    ...
    void SetNewTimeStampLost(double t);
...
protected:
    ...
    // 用于Online ORB + Offline Cloud测试
    bool CloudNeedNewKeyFrame();
